...
[Defines]
  PLATFORM_NAME                  = NT32
  PLATFORM_GUID                  = 1A803E7F-E378-4398-816C-AEA83E296D3E
  ...
  FLASH_DEFINITION               = Nt32Pkg/Nt32PkgMsCapsule.fdf
  #
...
[LibraryClasses]
  ...
  MsSafeBaseLib|MsCapsuleUpdatePkg/Library/BaseMsSafeBaseLib/SafeBaseLib.inf
...
[BuildOptions]
  ...
  !if $(SHIP_MODE) == TRUE
    DEFINE SHIP_MODE_OPTIONS = /D SHIP_MODE=1
  !else
    DEFINE SHIP_MODE_OPTIONS =
  !endif

  DEFINE EDK_EDKII_DSC_FEATURE_BUILD_OPTIONS = $(SHIP_MODE_OPTIONS)
  ...
  *_*_IA32_ASLCC_FLAGS   = $(EDK_EDKII_DSC_FEATURE_BUILD_OPTIONS)
  ...
  *_*_X64_ASLCC_FLAGS    = $(EDK_EDKII_DSC_FEATURE_BUILD_OPTIONS)
