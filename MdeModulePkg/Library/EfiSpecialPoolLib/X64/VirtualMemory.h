...
#define IA32_PG_USER                BIT2


/**
  Writes the Tr selector.

  Writes and the current TR descriptor specified by LTR. This function is
  only available on IA-32 and x64.

  @param  Ltr  16-bit TR selector value.
